...
payment_route.set('view engine','hbs');
payment_route.set('views',path.join(__dirname, '../tempelates'));

const paymentController = require('./controllers/paymentController');

payment_route.get('/paymentGateway', paymentController.renderBuyPage);
